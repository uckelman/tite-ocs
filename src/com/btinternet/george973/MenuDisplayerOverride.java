...
public class MenuDisplayerOverride extends MouseAdapter implements Buildable {
   ...
   */
    ...
    if (c != null) {
      ...
      for (int i = 0; i < c.length; ++i) {
        ...
        } else if (c[i] instanceof TiteTraitBase.AttachKeyCommand ) {
          TiteTraitBase.AttachKeyCommand a = (TiteTraitBase.AttachKeyCommand) c[i];
          JMenu subMenu = a.getMenu();
          subMenu.setFont(POPUP_MENU_FONT);
          item = subMenu;
