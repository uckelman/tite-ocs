...
public class RegionGridOverride extends RegionGrid {
    ...
    public Region snapToRegion(Point p) {
    ...
    public String locationName(Point p) {
        ...
        final Region region = snapToRegion(p);
  ...
  public static class Config extends JFrame implements MouseListener, MouseMotionListener, ActionListener, KeyListener {
    ...
    public Config(RegionGridOverride grid) {
    ...
    public void save() {
      ...
      for (Region r : grid.regionList.values()) {
        saveRegions.add(new RegionOverride((RegionOverride)r));
      }
    }
...
// FIXME: make this an ImageOp?
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (command.equals("close")) {
        ...
        final Region r = new RegionOverride(lastClick);
        r.addTo(grid);
        grid.add(r);
        select(r);
        lastClickedRegion = r;
    ...
    class EditRegionAction extends EditPropertiesAction {
      ...
      public EditRegionAction(Region target, HelpWindow helpWindow, Config dialogOwner) {
        ...
        owner = dialogOwner;
        origRegion = new RegionOverride((RegionOverride)target);
        region = target;
